...
const createMobileQueryClient = (): QueryClient => new QueryClient({
    defaultOptions: {
        queries: {
...
const MobileOfflineContext = createContext<MobileOfflineContextType | undefined>(undefined)
...
export function Providers({ children }: { children: ReactNode }): JSX.Element {
    ...
    useEffect(() => {
        ...
        const handleOnline = (): void => {
            ...
            mobileSyncManager.startMobileSync().then(() => {
...
export const useMobileOffline = (): MobileOfflineContextType => {
    ...
    if (context === undefined) {
        throw new Error('useMobileOffline must be used within a MobileOfflineProvider')
    }
    return context
}
