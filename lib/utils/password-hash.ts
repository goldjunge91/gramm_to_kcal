...
export function validatePasswordStrength(password: string) {
  ...
  if (!checks.minLength) messages.push(`At least ${minLength} characters`);
...
export function validatePasswordSecurity(password: string) {
  ...
  if (isCommonPassword) additionalMessages.push("Avoid common passwords");
  if (hasRepeatedChars) additionalMessages.push("Avoid repeated characters");
  if (hasSequential) additionalMessages.push("Avoid sequential characters");
