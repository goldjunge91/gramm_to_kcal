...
/**
 * A database of density values for various substances, including cooking ingredients,
 * chemicals, medical solutions, and common fluids. Each entry provides the substance's
 * name (in English and German), density (in g/cm³), temperature (if applicable), category,
 * description, and optional aliases for lookup.
 *
 * Categories include:
 * - `cooking`: Common kitchen ingredients and liquids.
 * - `chemistry`: Chemical substances and solvents.
 * - `medicine`: Medical solutions and preparations.
 * - `common`: Frequently encountered fluids (e.g., fuels).
 *
 * Density values are typically given at standard temperature (specified per entry).
 *
 * @remarks
 * This database is intended for use in conversions between mass and volume,
 * scientific calculations, and educational purposes.
 *
 * @see DensityData
 */
