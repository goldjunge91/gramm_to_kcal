...
export function findDensityData(searchTerm: string): DensityData | undefined {
  ...
  return DENSITY_DATABASE.find(item => 
 ...
 */
export function getDensityDataByCategory(category: DensityData['category']): DensityData[] {
...
export function searchDensityData(searchTerm: string): DensityData[] {
  ...
  return DENSITY_DATABASE.filter(item =>
 ...
 */
export function getCategoryDisplayName(category: DensityData['category']): string {
  const categoryNames = {
