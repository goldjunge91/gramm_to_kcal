  ...
  const handleFileUpload = useCallback(
    async (file: File) => {
      ...
      if (!file.type.startsWith("image/")) {
        setUploadError("Bitte wähle eine Bilddatei aus (PNG, JPG, etc.)");
        return;
      }
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 bg-background sm:hidden">
        <div className="flex flex-col h-screen">
                    ...
                    {isProcessingFile ? (
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-xs text-muted-foreground">
                          Unterstützt: PNG, JPG, GIF • Max: 10MB
                        </p>
                      </div>
                    )}
                  </div>
          ...
          {((scanMode === "camera" && (error || (!isLoading && !error))) ||
            ...
            <div className="flex-shrink-0 p-4 space-y-4">
              ...
              {/* Instructions */}
              {!error && !uploadError && scanMode === "camera" && (
              ...
              {!error && !uploadError && scanMode === "upload" && (
                <div className="text-xs text-muted-foreground text-center">
                  <p>• EAN-13 Barcodes funktionieren am besten</p>
                  <p>• Gute Beleuchtung und scharfe Bilder helfen</p>
                </div>
              )}
